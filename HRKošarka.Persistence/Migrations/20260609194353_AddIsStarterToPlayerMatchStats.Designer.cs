...
namespace HRKošarka.Persistence.Migrations
{
    ...
    [Migration("20260609194353_AddIsStarterToPlayerMatchStats")]
    partial class AddIsStarterToPlayerMatchStats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRKošarka.Domain.League", b =>
                {
                    ...
                    b.Property<DateTime?>("PlayoffEndDate")
                        .HasColumnType("datetime2");

                    b.Property<bool>("PlayoffGenerated")
                        .HasColumnType("bit");

                    b.Property<bool>("PlayoffHas3rdPlace")
                        .HasColumnType("bit");

                    b.Property<string>("PlayoffRoundWinsNeeded")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("HRKošarka.Domain.LeagueBreak", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRKošarka.Domain.Match", b =>
                {
                    ...
                    b.Property<int>("ResultSubmissionStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRKošarka.Domain.PlayerSeasonStats", b =>
                {
                    ...
                    b.Property<decimal>("AverageFouls")
                        .HasPrecision(5, 2)
            ...
            modelBuilder.Entity("HRKošarka.Domain.PlayoffSeries", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("AwayFeederSeriesId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("AwaySeedNumber")
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("HomeFeederSeriesId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("HomeSeedNumber")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WinsNeeded")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("AwayFeederSeriesId");

                    b.HasIndex("AwayTeamId");

                    b.HasIndex("HomeFeederSeriesId");
                    ...
                    b.HasIndex("LeagueId", "RoundNumber")
                        .HasDatabaseName("IX_PlayoffSeries_LeagueId_RoundNumber");

                    b.HasIndex("LeagueId", "RoundNumber", "SeriesNumber")
                        .IsUnique()
                        .HasDatabaseName("IX_PlayoffSeries_LeagueId_RoundNumber_SeriesNumber");

                    b.ToTable("PlayoffSeries", t =>
                        {
                            t.HasCheckConstraint("CK_PlayoffSeries_WinsNeeded", "WinsNeeded BETWEEN 2 AND 4");
                        });
                });
            ...
            modelBuilder.Entity("HRKošarka.Domain.Match", b =>
                {
                    ...
                    b.HasOne("HRKošarka.Domain.PlayoffSeries", "PlayoffSeries")
                        .WithMany("Matches")
            ...
            modelBuilder.Entity("HRKošarka.Domain.PlayoffSeries", b =>
                {
                    b.HasOne("HRKošarka.Domain.PlayoffSeries", "AwayFeederSeries")
                        .WithMany()
                        .HasForeignKey("AwayFeederSeriesId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("HRKošarka.Domain.PlayoffSeries", "HomeFeederSeries")
                        .WithMany()
                        .HasForeignKey("HomeFeederSeriesId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("AwayFeederSeries");

                    b.Navigation("AwayTeam");

                    b.Navigation("HomeFeederSeries");
